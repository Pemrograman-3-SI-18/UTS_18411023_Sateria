      ...
      <q-page padding class="row items-center justify-center">
        <div class="row full-width">
          <div class="col-md-8 offset-md-2 col-xs-12 q-pl-md q-pr-md q-pt-sm">
            <q-card flat class="bg-grey text-black">
              <div class="row">
                ...
                <div class="col-md-12 col-xs-12 q-pt-md">
                  <div class="q-pa-md">
                    ...
                    >
                      ...
                      <div>
                        <q-btn label="Log in" to="/auth/Login" type="submit" color="primary"/>
                        <q-btn label="Registrasi" to="/auth/Login" color="primary" flat class="q-ml-sm" />
                      </div>
                    </q-form>
